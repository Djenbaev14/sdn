            ...
            <div class="col-12">
              <div class="card-block p-3 mt-3" style="background: #fff" >
                <div class="card-body d-flex justify-content-between align-items-center">
                  <h4 class="card-title">Меню қосыў</h4>
                  ...
                  @foreach (config('app.available_locales') as $local)
                    <div class="tab-pane  <?=($local['lang']=='ru' ? 'show active' : '')?>" id="menu_{{$local['lang']}}">
                      <div class="mb-3">
                        ...
                        ?>
                        <input type="text" name="title_{{$local['lang']}}" id="simpleinput"  value="{{old('email')}}" class="form-control">
                      </div>
                    </div>
                  @endforeach
                    <select class="form-select mb-3 w-25" name="type">
