  ...
  <div class="content">
      ...
      <div class="container-fluid">
          ...
          <div class="card-block p-3" style="background: #fff" >
            <form action="{{ route('dashboard.items.store') }}" class="form-main" method="POST">
                @csrf
                <div class="row">
                  ...
                  <div class="mb-3">
                      <div class="form-check">
                          <input type="checkbox" class="form-check-input" id="myCheck" name="is_news" onclick="myFunction()">
                    ...
                    @foreach (config('app.available_locales') as $local)
                      <div class="tab-pane mt-2   <?=($local['lang']=='ru' ? 'show active' : '')?>" id="item_{{$local['lang']}}">
                        <div class="col-md-12">
                          ...
                          <input placeholder="Бет аты" type="text" name="name_{{$local['lang']}}" value="{{old('name_'.$local['lang'])}}" id="simpleinput" class="form-control">
                        </div>
